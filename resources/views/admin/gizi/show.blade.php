    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.gizi.show', $gizi->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label>NAMA ANAK</label>
                            <select disabled class="form-control select-category @error('databalita_id') is-invalid @enderror "
                                name="databalita_id">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BB/U</label>
                                    <input readonly type="text" name="BBU" value="{{ old('BBU', $gizi->BBU) }}" placeholder="BBU"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>TB/U</label>
                                    <input readonly type="text" name="TBU" value="{{ old('TBU', $gizi->TBU) }}" placeholder="TBU"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BB/TB</label>
                                    <input readonly type="text" name="BBTB" value="{{ old('BBTB', $gizi->BBTB) }}" placeholder="BBTB"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_BB/U</label>
                                    <input readonly type="text" name="Z_BBU" value="{{ old('Z_BBU', $gizi->Z_BBU) }}" placeholder="Z_BBU"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_TB/U</label>
                                    <input readonly type="text" name="Z_TBU" value="{{ old('Z_TBU', $gizi->Z_TBU) }}" placeholder="Z_TBU"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_BB/TB</label>
                                    <input readonly type="text" name="Z_BBTB" value="{{ old('Z_BBTB', $gizi->Z_BBTB) }}" placeholder="Z_BBTB"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div  class="form-group">
                                    ...
                                    <input readonly type="text" name="status_gizi" value="{{ old('status_gizi', $gizi->status_gizi) }}" placeholder="Status Gizi"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_SCORE</label>
                                    <input readonly type="text" name="z_score" value="{{ old('z_score', $gizi->z_score) }}" placeholder="Z_Score"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" name="validasi" value="{{ old('validasi', $gizi->validasi) }}" placeholder="Validasi"
