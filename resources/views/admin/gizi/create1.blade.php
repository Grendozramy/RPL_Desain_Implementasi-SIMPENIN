                    ...
                    <form action="{{ route('admin.gizi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row" style="display: none;">>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_BB/U</label>
                                    <input type="text" name="Z_BBU" value="-" placeholder="Z_BBU"
                            ...
                            <div class="col-md-6" style="display: none;">>
                                <div class="form-group">
                                    <label>Z_TB/U</label>
                                    <input type="text" name="Z_TBU" value="-" placeholder="Z_TBU"
                        ...
                        <div class="row" style="display: none;">>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Z_BB/TB</label>
                                    <input type="text" name="Z_BBTB" value="-" placeholder="Z_BBTB"
                        ...
                        <div class="row" style="display: none;">>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BB/U</label>
                                    <input type="text" name="BBU" value="-" placeholder="BBU"
                            ...
                            <div class="col-md-6" style="display: none;">>
                                <div class="form-group">
                                    <label>TB/U</label>
                                    <input type="text" name="TBU" value="-" placeholder="TBU"
                        ...
                        <div class="row" style="display: none;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>BB/TB</label>
                                    <input type="text" name="BBTB" value="-" placeholder="BBTB"
...
$(document).on("change", "#dataanak_id", function(){
    	var tahun = $(this).val()

    	$.ajax({
    		url: "{{ route('admin.gizi.create') }}",
    		method: "GET",
