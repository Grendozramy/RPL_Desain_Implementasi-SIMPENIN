        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-user-md"></i> Petugas</h4>
                </div>
                ...
                <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                @can('petugas.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('admin.petugas.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
                    ...
                    <div class="table-responsive">
                        ...
                        <div style="text-align: center">
                            {{$petugas->links("vendor.pagination.bootstrap-4")}}
                        </div>
                    </div>
                </div>
            </div>
