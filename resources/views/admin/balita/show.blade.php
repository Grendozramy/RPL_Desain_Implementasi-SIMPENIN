            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.balita.show', $balita->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" name="usia_balita" value="{{ old('usia_balita', $balita->usia_balita) }}" placeholder="Masukkan Usia Anak"
                        ...
                        <a href="{{ route('admin.balita.index') }}" class="btn btn-primary mr-1" ><i class="fa fa-arrow-left"></i>
                            BACK</a>
                    </form>
                </div>
            </div>
