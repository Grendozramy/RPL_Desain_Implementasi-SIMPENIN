        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-unlock"></i> Edit Posyandu</h4>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.posyandu.update', $posyandu->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            <label>JADWAL</label>
                            <input type="date" name="jadwal" value="{{ old('jadwal', $posyandu->jadwal) }}" placeholder="Masukkan Jadwal"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_posyandu" value="{{ old('nama_posyandu', $posyandu->nama_posyandu) }}" placeholder="Masukkan Nama Posyandu"
                        ...
                        <div class="form-group">
                            <label>TEMPAT</label>
                            <input type="text" name="tempat" value="{{ old('tempat', $posyandu->tempat) }}" placeholder="Masukkan Nama Tempat"
