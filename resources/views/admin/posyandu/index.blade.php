        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-hospital"></i> Data Posyandu</h4>
                </div>
                ...
                <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                @can('posyandu.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('admin.posyandu.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle">
                                            </i>TAMBAH</a>
                                    </div>
                                @endcan
                    ...
                    <div class="table-responsive">
                            ...
                            @foreach ($posyandus as $no => $posyandu)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @can('posyandu.delete')
                                            <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $posyandu->id }}">
                        ...
                        <div style="text-align: center">
                            {{$posyandus->links("vendor.pagination.bootstrap-4")}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "{{ route("admin.posyandu.index") }}/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
